...
$name = $_POST['reg_name'];
$secName = $_POST['reg_secName'];
$email = $_POST['reg_email'];
$contact = $_POST['reg_contact'];
$price = $_POST['reg_price'];
...
<table>
    <tr>
        <th align="left"><strong>Имя:</th>
        <td align="left">' . $name . '</td>
    </tr>
    <tr>
        <th align="left"><strong>Фамилия:</th>
    ...
    <tr>
        <th align="left"><strong>Ноер телефона:</th>
        <td align="left">' . $contact . '</td>
    </tr>
    <tr>
        <th align="left"><strong>Меня интересует тариф:</th>
